    ...
    <div class="page-wrapper bg-custom p-t-45 p-b-50">
		...
		<form action='submitForm' method='post' enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                    <input class="input--style-5" type="text" name="gender">
		            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value" style="background:white;">
                                <div class="input-group">
                                    <input class="input--style-5" type="file" name="docname">
                                </div>
                            </div>
                        </div>
...
<div>
<button class="btn btn--radius-1" style="color:white;background:black;" type="submit">Register</button>&emsp;&emsp;&emsp;
